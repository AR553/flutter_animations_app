...
class _BallAnimationPageState extends State<BallAnimationPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _controller = AnimationController(vsync: this, duration: Duration(milliseconds: 800),upperBound: .9)..forward()..repeat(reverse: true);
  }
  ...
  double curve(double value){
    return Curves.easeOutExpo.transform(value);
  }
